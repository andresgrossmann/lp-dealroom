...
function Documents({ buyer, ndaSigned, onNdaSign }) {
  ...
  const docs = [
    ...
    { name: "Q1 2026 Operating Reports (Jan-Mar)", desc: "Actual operating P&L \u2014 January, February, and March 2026", icon: "\uD83D\uDCCA", url: "https://docs.google.com/spreadsheets/d/1atJ_pLGge6XHV_GjZeI3BQSj13y4E00H/edit?usp=sharing&ouid=113699395715492196821&rtpof=true&sd=true" },
